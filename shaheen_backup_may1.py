...
# الهوية البصرية: اسم المنصة والشعار المرفق بخط واضح
...
# الربط العالمي باستخدام مفتاحك الجديد (sk-or-v1-d98d...)
    ...
    if prompt := st.chat_input("تحدث مع شاهين العالمي... العلم نور"):
        ...
        with st.chat_message("assistant"):
            try:
                ...
                st.error(f"نظام الحماية نشط. تأكد من تفعيل الرصيد في OpenRouter. الخطأ: {e}")
else:
    # قفل الأرباح الذهبي
